...
spp VeloPix_scramble_TX(spp frameIn, int i)
{
  ...
  dataOutEval[14] = frameIn[14] ^ state[i][14] ^ state[i][15] ^ state[i][29] ^ dataOutEval[0];
  dataOutEval[15] = frameIn[15] ^ state[i][15] ^ state[i][16] ^ dataOutEval[0]   ^ dataOutEval[1];
  dataOutEval[16] = frameIn[16] ^ state[i][16] ^ state[i][17] ^ dataOutEval[1]   ^ dataOutEval[2];
  dataOutEval[17] = frameIn[17] ^ state[i][17] ^ state[i][18] ^ dataOutEval[2]   ^ dataOutEval[3];
  dataOutEval[18] = frameIn[18] ^ state[i][18] ^ state[i][19] ^ dataOutEval[3]   ^ dataOutEval[4];
  dataOutEval[19] = frameIn[19] ^ state[i][19] ^ state[i][20] ^ dataOutEval[4]   ^ dataOutEval[5];
  dataOutEval[20] = frameIn[20] ^ state[i][20] ^ state[i][21] ^ dataOutEval[5]   ^ dataOutEval[6];
  dataOutEval[21] = frameIn[21] ^ state[i][21] ^ state[i][22] ^ dataOutEval[6]   ^ dataOutEval[7];
  dataOutEval[22] = frameIn[22] ^ state[i][22] ^ state[i][23] ^ dataOutEval[7]   ^ dataOutEval[8];
  dataOutEval[23] = frameIn[23] ^ state[i][23] ^ state[i][24] ^ dataOutEval[8]   ^ dataOutEval[9];
  dataOutEval[24] = frameIn[24] ^ state[i][24] ^ state[i][25] ^ dataOutEval[9]   ^ dataOutEval[10];
  dataOutEval[25] = frameIn[25] ^ state[i][25] ^ state[i][26] ^ dataOutEval[10]  ^ dataOutEval[11];
  dataOutEval[26] = frameIn[26] ^ state[i][26] ^ state[i][27] ^ dataOutEval[11]  ^ dataOutEval[12];
